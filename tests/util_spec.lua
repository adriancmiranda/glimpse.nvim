...
describe('util', function()
	...
	describe('is_model', function()
		it('returns true for supported 3D model extensions', function()
			assert.is_true(util.is_model('/path/to/model.obj'))
			assert.is_true(util.is_model('/path/to/model.fbx'))
			assert.is_true(util.is_model('/path/to/model.dae'))
			assert.is_true(util.is_model('/path/to/model.glb'))
			assert.is_true(util.is_model('/path/to/model.gltf'))
			assert.is_true(util.is_model('/path/to/model.3ds'))
			assert.is_true(util.is_model('/path/to/model.3mf'))
			assert.is_true(util.is_model('/path/to/model.ply'))
			assert.is_true(util.is_model('/path/to/model.stl'))
			assert.is_true(util.is_model('/path/to/model.off'))
			assert.is_true(util.is_model('/path/to/model.x'))
			assert.is_true(util.is_model('/path/to/model.dxf'))
			assert.is_true(util.is_model('/path/to/model.wrl'))
			assert.is_true(util.is_model('/path/to/model.vrml'))
			assert.is_true(util.is_model('/path/to/model.stp'))
			assert.is_true(util.is_model('/path/to/model.step'))
			assert.is_true(util.is_model('/path/to/model.igs'))
		...
		it('is case-insensitive', function()
			assert.is_true(util.is_model('/path/to/MODEL.OBJ'))
			assert.is_true(util.is_model('/path/to/Scene.GLB'))
		end)

		it('returns false for non-model files', function()
			assert.is_false(util.is_model('/path/to/image.png'))
			assert.is_false(util.is_model('/path/to/video.mp4'))
			assert.is_false(util.is_model('/path/to/noext'))
		end)
	end)
