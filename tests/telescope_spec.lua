...
describe('telescope integration', function()
	...
	it('renders image and video previews through the media path', function()
		...
		assert.is_not_nil(render_calls[1].opts.bufname:match('^glimpse://preview/'))
		...
		assert.is_not_nil(render_calls[2].opts.bufname:match('^glimpse://preview/'))
	...
	it('returns stable but isolated buffer names for media previews', function()
		...
		assert.is_not_nil(image_name:match('^glimpse://preview/'))
		assert.is_not_nil(video_name:match('^glimpse://preview/'))
